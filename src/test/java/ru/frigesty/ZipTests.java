                    ...
                    if (entry.getName().endsWith(".csv")) {
                        try (InputStream inputStreamCsv = zipFile.getInputStream(entry)) {
                            ...
                            assertThat(csvContent).contains(
                                    new String[]{"Login email", "Identifier", "One-time password",
                                            "Recovery code", "First name", "Last name", "Department", "Location"},
                                    new String[]{"rachel@example.com", "9012", "12se74", "rb9012",
                                            "Rachel", "Booker", "Sales", "Manchester"},
                                    new String[]{"laura@example.com", "2070", "04ap67", "lg2070",
                                            "Laura", "Grey", "Depot", "London"},
                                    new String[]{"craig@example.com", "4081", "30no86", "cj4081",
                                            "Craig", "Johnson", "Depot", "London"},
                                    new String[]{"mary@example.com", "9346", "14ju73", "mj9346",
                                            "Mary", "Jenkins", "Engineering", "Manchester"},
                                    new String[]{"jamie@example.com", "5079", "09ja61", "js5079",
